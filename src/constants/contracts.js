...
export const REQUIRED_FFS_BOTTLE_ADDRESS = '0x11cc5f9b4012a08fb9fd46fa47ad96e37a5f2605'
...
export const FFS_BOTTLE_ABI = [
  { type: 'function', name: 'POUR_AMOUNT', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { type: 'function', name: 'bottleBalance', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { type: 'function', name: 'currentRound', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { type: 'function', name: 'fillPercent', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { type: 'function', name: 'pour', stateMutability: 'nonpayable', inputs: [], outputs: [] },
  { type: 'function', name: 'roundPours', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { type: 'function', name: 'totalPours', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
  { type: 'function', name: 'totalSips', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
