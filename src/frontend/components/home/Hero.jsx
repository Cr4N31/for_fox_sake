...
function Hero(){
    const tokenData = [
        { name: "Holders", value: 0, color: "#fffff"},
        ...
        <section className="my-30 bg-cover gap-2 md:my-18 flex md:flex-row flex-col md:p-16 p-4 justify-between items-center">
            <div className="flex flex-col gap-4 items-left justify-left">
                ...
                <div className='flex gap-2 flex-col'>
                    <h1 className="font-extrabold text-6xl uppercase bg-fire bg-clip-text text-transparent">For Fox <br/><span className='bg-neon bg-clip-text text-transparent'>Sake</span></h1>
                    <h2 className="tracking-widest text-2xl text-cyan-300">SIP. STAKE. WIN</h2>
                    <h3 className='text-white/70'>Enter the neon fox tavern. Pour your $FFS into the mystical sake bottle. <br/> When the bottle sips, fate decides who walks away with the treasury.</h3>
                ...
                <div className='flex gap-4 text-center justify-left items-center'>
                    ...
                    <button className='bg-black/50 hover:bg-cyan-900/90 transiton-all duration-150 uppercase text-white/80 p-3 tracking-wide rounded-2xl border border-cyan-300'>
                        Enter Tavern &rarr;
                    </button>
                </div>
