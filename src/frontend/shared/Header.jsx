function Header({ isOpen, onMenuClick }) {
    return (
        <header className="fixed top-4 left-1/2 -translate-x-1/2 bg-white/50 p-2 my-4 rounded-xl border-2 border-purple-300/40 backdrop-blur-md w-[95%] max-w-6xl flex justify-between items-center z-50 shadow-[0_0_25px_rgba(168,85,247,0.2)]">
            ...
            <div className="flex items-center gap-3 px-4">
                ...
                {/* CONNECT BUTTON */}
                <button className="flex items-center px-4 py-2 rounded-xl text-white bg-gradient-to-r from-pink-400 via-purple-400 to-pink-600 gap-2 shadow-[0_0_20px_rgba(217,70,239,0.7)] hover:shadow-[0_0_30px_rgba(217,70,239,1)] hover:scale-105 transition duration-300">
